...
const Chatbot = () => {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 font-sans">
      ...
      <motion.div
        className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center text-white text-3xl cursor-pointer shadow-lg hover:bg-blue-700 transition-transform duration-200"
      ...
      {isOpen && (
        <motion.div
          className="w-80 h-[450px] bg-white rounded-2xl overflow-hidden flex flex-col mb-2 shadow-2xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4 }}
        >
          {/* Chat Messages */}
          <div className="flex-1 p-4 overflow-y-auto bg-slate-100 chatbot-messages">
            {messages
          ...
          <div className="p-2 bg-white border-t border-gray-200 flex">
            <input
              ...
              disabled={isLoading}
              className="flex-1 p-2 border border-gray-300 rounded-l-2xl focus:outline-none"
